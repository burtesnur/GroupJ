...
public class FreezeFeedbackFlashHUD : MonoBehaviour
{
    [Header("References")]
    ...
    public CanvasGroup frozenCanvasGroup;
    public float frozenMaxAlpha = 0.1f;
    ...
    void Start()
    {
        ...
        m_Freeze = FindObjectOfType<Freeze>();
    ...
    private void Update()
    {
        ...
        {
            frozenCanvasGroup.gameObject.SetActive(true);
            frozenCanvasGroup.alpha = frozenMaxAlpha;
        }
        else
        {
            frozenCanvasGroup.gameObject.SetActive(false);
        }
    }
